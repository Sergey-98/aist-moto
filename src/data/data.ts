...
import f1 from '../assets/img/Benda/funrider125/1.jpg';
import f2 from '../assets/img/Benda/funrider125/2.jpg';
import f3 from '../assets/img/Benda/funrider125/3.jpg';
        ...
        pages:[
            {
                ...
                mainDescription: [
                    {
                        desc: 'Benda Funrider 125 – классический круизер, ориентированный в первую очередь на начинающих райдеров. Несмотря на скромный, всего 125 куб. см, рабочий объём, силовой агрегат «Фанрайдера» выполнен в полном соответствии с канонами круизеростроения: это двухцилиндровый V-образный двигатель. Более того, мотор жидкостного охлаждения, а за подготовку топливовоздушной смеси отвечает система впрыска топлива. 125-кубовый V-твин Benda Funrider развивает максимальную мощность почти 15 л.с. при 8500 об/мин и достигает пикового значения крутящего момента – 14 Нм – при 6500 об/мин. При этом для управления этим круизером достаточно водительского удостоверения категории «А1», т.е. сесть за руль Benda Funrider 125 можно уже в 16 лет',
                        photo: f1
                    },
                    {
                        desc: 'Установленный в стальную раму двигатель работает в паре с 6-ступенчатой коробкой передач, крутящий момент на заднее колесо передаётся цепью. Benda Funrider 125 получила переднюю вилку перевёрнутого типа и маятниковую заднюю подвеску с двумя амортизаторами. Стильные 16-спицевые литые колёса диаметром 17 дюймов обуты в высокопрофильные шины размерности 120/80 спереди и 140/70 сзади. На обоих колёсах Benda Funrider 125 установлены дисковые тормоза с двухпоршневыми суппортами. Эффективности их работы достаточно для лёгкого круизера: мотоцикл прогнозируемо замедляется даже с пассажиром.',
                        photo: f2
                    },
                    {
                        desc: 'Мотоцикл оснащён полностью светодиодной оптикой. Фара головного цвета, выполненная в классическом круглом корпусе, выглядит очень интересно и прекрасно освещает дорогу, а олдскульные каплеобразные указатели поворотов отлично читаются в потоке. Установленная на руле жидкокристаллическая приборная панель снабжает водителя всей необходимой информацией. При спокойном стиле вождения Benda Funrider 125 потребляет чуть более двух литров бензина на 100 км, при более динамичном перемещении может даже выйти за 3 литра. Объём бензобака же составляет внушительные 19 литров, обеспечивая круизеру огромный запас хода – более полутысячи километров. Даже при городском передвижении преимущественно по маршруту дом-работа-дом удобно, когда нет необходимости ежедневно заезжать на заправку.',
                        photo: f3
                    }
                ],
                description: {	
